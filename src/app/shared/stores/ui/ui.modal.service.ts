...
import { ConfirmationModalComponent, LogoutModalComponent, ViewerImgComponent } from '@modals';
...
type modals = 'LogoutModalComponent' | 'ConfirmationModalComponent' | 'ViewerImgComponent';
...
export class UIModalService {
  ...
  public modalList = {
    ...
    ViewerImgComponent: ViewerImgComponent
  };
